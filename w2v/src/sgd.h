void sgd_ls(DataPointLS *datapoints, int thread, int n_points, double * __restrict__ model) {
  pin_to_core(thread);
  for (int i = 0; i < n_points; i++) {
    DataPointLS p = datapoints[i];
...
void sgd(DataPoint *datapoints, int thread, int n_points, int vector_length, double * __restrict__ local_model, double C, double ** __restrict__ C_sum_mult, double ** __restrict C_sum_mult2) {
    pin_to_core(thread);
    for (int i = 0; i < n_points; i++) {
